...
| `corpus/` | **Transcriptions**, one file per archival file. 375 files, 8,735 scans, released as work proceeds — see [`corpus/README.md`](corpus/README.md) |
...
- The rest of the fond: 42,273 scans not yet transcribed
