...
words; on 43\% of pairs no run reaches ten words at all. Broken out by \texttt{ink\_cv},
...
a snapshot of work in progress. \texttt{check\_paper.py} recomputes twenty of them from
